        ...
        <div class="table-place-full">      
            <table class="table table-bordered dt-responsive nowrap table-striped table-hover" style="width:100%" id="t_kategori">
                ...
                <tr>
                  ...
                  <th scope="col" class="text-center">Kategori Alkes</th>
...
<div class="modal fade mt-3" id="modal-tambah" role="dialog" aria-labelledby="modal-kategori" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modal-kategori">Kategori Alkes</h4>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label class="col-sm-12">Kategori Alkes</label>
          <div class="col-sm-12 col-md-12">
            <input class="form-control" type="text" name="kategori" id="kategori" placeholder="Kategori Alkes" required>
          </div>
        </div>
        </form>
      </div>
  ...
  <script>
    $('document').ready(function(){
      ...
      table = $('#t_kategori').DataTable({
          ...
          "ajax": {
              "url": "<?php echo site_url('a_kategori_alkes/get_kategori_alkes')?>",
              "type": "POST"
          },
          "columnDefs": [
          {
      ...
      $("#simpan").click(function(e) {
        ...
        if($('#form').parsley().validate()){
          ...
          $.ajax({
            ...
            cache: false,
            async:true,
            url     : "<?php echo site_url('a_kategori_alkes/simpan');?>",
      ...
      $('#t_kategori').on( 'click', 'tr .edit', function () {
        ...
        $('#form').parsley().reset();
          ...
          $.ajax({
            type    : 'POST',
            data    : {id:id},
            url     : "<?php echo site_url('a_kategori_alkes/cari_kategori_alkes');?>",
            dataType: 'json',
            success : function(data) {
              $('#id').val(data.id);
          ...
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type    : 'POST',
                        data    : {id:id},
                        url     : "<?php echo site_url('a_kategori_alkes/hapus');?>",
                        success : function(data) {
