  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modal-kategori">Kategori Obat</h4>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label class="col-sm-12">Kategori Obat</label>
          <div class="col-sm-12 col-md-12">
            <input class="form-control" type="text" name="kategori" id="kategori" placeholder="Kategori Obat" required>
          </div>
        </div>
        </form>
      </div>
  ...
  <script>
    $('document').ready(function(){
      ...
      table = $('#t_kategori').DataTable({
          ...
          "ajax": {
              "url": "<?php echo site_url('a_kategori/get_kategori')?>",
              "type": "POST"
          },
          "columnDefs": [
          {
      ...
      $("#simpan").click(function(e) {
        ...
        if($('#form').parsley().validate()){
          ...
          $.ajax({
            ...
            cache: false,
            async:true,
            url     : "<?php echo site_url('a_kategori/simpan');?>",
      ...
      $('#t_kategori').on( 'click', 'tr .edit', function () {
        ...
        $('#form').parsley().reset();
          ...
          $.ajax({
            type    : 'POST',
            data    : {id:id},
            url     : "<?php echo site_url('a_kategori/cari_kategori');?>",
            dataType: 'json',
            success : function(data) {
              $('#id').val(data.id);
          ...
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type    : 'POST',
                        data    : {id:id},
                        url     : "<?php echo site_url('a_kategori/hapus');?>",
                        success : function(data) {
