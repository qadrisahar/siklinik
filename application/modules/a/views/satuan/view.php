  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modal-satuan">Data satuan</h4>
  ...
  <script>
    $('document').ready(function(){
      ...
      table = $('#t_satuan').DataTable({
          ...
          "ajax": {
              "url": "<?php echo site_url('a_satuan/get_satuan')?>",
              "type": "POST"
          },
          "columnDefs": [
          {
      ...
      $("#simpan").click(function(e) {
        ...
        if($('#form').parsley().validate()){
          ...
          $.ajax({
            ...
            cache: false,
            async:true,
            url     : "<?php echo site_url('a_satuan/simpan');?>",
      ...
      $('#t_satuan').on( 'click', 'tr .edit', function () {
        ...
        $('#form').parsley().reset();
          ...
          $.ajax({
            type    : 'POST',
            data    : {id:id},
            url     : "<?php echo site_url('a_satuan/cari_satuan');?>",
            dataType: 'json',
            success : function(data) {
              $('#id').val(data.id);
          ...
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type    : 'POST',
                        data    : {id:id},
                        url     : "<?php echo site_url('a_satuan/hapus');?>",
                        success : function(data) {
