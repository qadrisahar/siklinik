...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 p-4 mb-3 card">  
        ...
        <div class="table-place-full">      
            <table class="table table-bordered dt-responsive nowrap table-striped table-hover" style="width:100%" id="t_satuan">
...
<div class="modal fade mt-3" id="modal-tambah" role="dialog" aria-labelledby="modal-satuan" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modal-satuan">Data Satuan Alkes</h4>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-12 col-md-12">
            <input class="form-control" type="text" name="satuan" id="satuan" placeholder="Satuan" required>
          </div>
        </div>
        </form>
      </div>
  ...
  <script>
    $('document').ready(function(){
      ...
      table = $('#t_satuan').DataTable({
          ...
          "ajax": {
              "url": "<?php echo site_url('a_satuan_alkes/get_satuan_alkes')?>",
              "type": "POST"
          },
          "columnDefs": [
          {
      ...
      $("#simpan").click(function(e) {
        ...
        if($('#form').parsley().validate()){
          ...
          $.ajax({
            ...
            cache: false,
            async:true,
            url     : "<?php echo site_url('a_satuan_alkes/simpan');?>",
      ...
      $('#t_satuan').on( 'click', 'tr .edit', function () {
        $('.modal-load').show();
        $('#form').parsley().reset();
          var id = $(this).data("id");
          $.ajax({
            type    : 'POST',
            data    : {id:id},
            url     : "<?php echo site_url('a_satuan_alkes/cari_satuan_alkes');?>",
            dataType: 'json',
            success : function(data) {
              $('#id').val(data.id);
      ...
      $('#t_satuan').on( 'click', 'tr .delete', function () {
          var id = $(this).data("id");
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type    : 'POST',
                        data    : {id:id},
                        url     : "<?php echo site_url('a_satuan_alkes/hapus');?>",
                        success : function(data) {
