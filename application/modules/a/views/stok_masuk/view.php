    ...
    <div class="col-lg-12 col-md-12 col-sm-12 p-4 mb-3 card">  
        <div class="table-action mb-2">
          <div class="text-right">
                <a href="<?=base_url().'a_stok_masuk/add'?>" class="btn-shadow btn btn-success">
  ...
  <script>
    $('document').ready(function(){
      ...
      table = $('#t_stok_masuk').DataTable({
          ...
          "ajax": {
              "url": "<?php echo site_url('a_stok_masuk/get_stok_masuk')?>",
              "type": "POST"
          },
          "columnDefs": [
          {
      ...
      $('#cari_obat').keyup(function(){
          ...
          {
               $.ajax({
                    url:"<?php echo site_url('a_stok_masuk/cari_obat');?>",
                    method:"POST",
                    data:{query:query},
      ...
      $("#simpan").click(function(e) {
        ...
        if($('#form').parsley().validate()){
          ...
          $.ajax({
            ...
            cache: false,
            async:true,
            url     : "<?php echo site_url('a_stok_masuk/simpan');?>",
            success : function(data) {
          ...
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type    : 'POST',
                        data    : {id:id},
                        url     : "<?php echo site_url('a_stok_masuk/hapus');?>",
                        success : function(data) {
