  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="modal-unit">Data Unit Alkes</h4>
  ...
  <script>
    $('document').ready(function(){
      ...
      table = $('#t_unit').DataTable({
          ...
          "ajax": {
              "url": "<?php echo site_url('a_unit_alkes/get_unit_alkes')?>",
              "type": "POST"
          },
          "columnDefs": [
          {
      ...
      $("#simpan").click(function(e) {
        ...
        if($('#form').parsley().validate()){
          ...
          $.ajax({
            ...
            cache: false,
            async:true,
            url     : "<?php echo site_url('a_unit_alkes/simpan');?>",
      ...
      $('#t_unit').on( 'click', 'tr .edit', function () {
        ...
        $('#form').parsley().reset();
          ...
          $.ajax({
            type    : 'POST',
            data    : {id:id},
            url     : "<?php echo site_url('a_unit_alkes/cari_unit_alkes');?>",
            dataType: 'json',
            success : function(data) {
              $('#id').val(data.id);
              $('#unit').val(data.unit);
          ...
          Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type    : 'POST',
                        data    : {id:id},
                        url     : "<?php echo site_url('a_unit_alkes/hapus');?>",
                        success : function(data) {
